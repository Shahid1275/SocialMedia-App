...
const Sidebar = ({ sidebaropen, setSidebaropen }) => {
  ...
  return (
    ...
    <Link to="/create-post" className='flex justify-center items-center gap-2 py-2.5 mt-6 mx-6 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-purple-800 active:scale-95 transition text-white cursor-pointer'> 
